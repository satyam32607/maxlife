...
public function __construct()
	{
		...
		$this->load->model('admin/dw/courses_model');
	...
	public function view()
	{
		...
		$this->load->view('admin/dw/courses/view', $data);		
	...
	public function view_chapters()
	{
		...
		$this->load->view('admin/dw/courses/view_chapters', $data);		
    } //end of view functionality
	...
	public function view_pages(){	
	   ...
	   //print_r($_POST);	
		...
		$config = array();
		$config["base_url"] = base_url() . "admin/dw/courses/view_pages/".$language_id."/".$chapter_id."/".$page_id."/".$per_page;
		...
		print_r($data);	  
		 echo "</pre>"; */	 
	    $this->load->view('admin/dw/courses/view_pages.php', $data);
		}
	   ...
	   $data['err']="";
		...
		if ($this->form_validation->run()) {
			...
			$file_name = time(true).$page_id.'.'.$fileExtension ;   
			  ...
			  $this->sdata_path = realpath('assets/static/dwaudios');
	...
	public function play_audio()
	{
		...
		echo $audioFilePath = base_url()."assets/static/dwaudios/".$file_name;



		 
/*	echo  $audio="<audio preload='none' class='ms-lg-auto' controls controlsList='nodownload'>
 <source src='".base_url()."assets/static/dwaudios/".$file_name."' type='audio/mpeg'>
