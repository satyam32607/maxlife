                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'comp_form','name' => 'comp_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'vendors/trainers/add', $attributes);
                         ?>
                        <div class="form-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                             <label class="control-label">Trainer Photo  <span class="required"> * </span></label>
                              ...
                              <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  <div> <span class="btn default btn-file"> <span class="fileinput-new"> Select image </span> <span class="fileinput-exists"> Change </span>
                                    <input id="user_photo" type="file" name="user_photo" class="upload" required  accept="image/*"/>
