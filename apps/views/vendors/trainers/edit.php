          ...
          <div class="page-content">
            <div class="container"> 
              ...
              <ul class="page-breadcrumb breadcrumb">
                <li> <a href="<?php echo base_url(); ?>vendors/dashboard">Dashboard</a> <i class="fa fa-circle"></i> </li>
                <li> <a href="<?php echo base_url(); ?>vendors/trainers/view"><?php echo $main_heading; ?></a> <i class="fa fa-circle"></i> </li>
                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                       <?php  $attributes = array('id' => 'comp_form','name' => 'role_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
							 echo form_open_multipart(base_url().'vendors/trainers/edit/'.$edit_data->user_id.'', $attributes);
					  ...
					  ?>
                         <div class="form-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                             <label class="control-label">Trainer Photo </label>
                              ...
                              <div class="form-group">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" id="dvPreview">
                                       ...
                                       {
                                            $photo    ='<img id="preview" src="'.base_url().'assets/static/'.$this->session->userdata('master_id').'/trainer_photos/resized/'.$edit_data->user_photo.'"> ';
                                       }
                                       else
                                       {
