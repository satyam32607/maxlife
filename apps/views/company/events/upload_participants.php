                            ...
                            <div class="page-content">
                                ...
                                <?php $this->load->view("includes/notifications.php");?>
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                            <a href="<?php echo base_url(); ?>company/dashboard">Dashboard</a>
                                            <i class="fa fa-circle"></i>
                                        </li>
                                          <li>
                                            <a href="<?php echo base_url(); ?>company/events/view"><?php echo $main_heading; ?></a>
                                            <i class="fa fa-circle"></i>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 col-sm-9 col-xs-9">
                                                          <?php  $attributes = array('id' => 'upload_customers_form','name' => 'upload_customers_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                                                                 echo form_open_multipart(base_url().'company/events/upload_participants', $attributes);
                                                               ...
                                                               <div class="col-md-6">
                                                                   ...
                                                                   <?php
																	 $fields = array('is_active'=>'1','company_id'=>$this->session->userdata('master_id'));
																 	 $event_array = gettabledropdown('events',$fields,'event_id','event_name','event_name','ASC');
																	 $selected = ($this->input->post('event_id')) ? $this->input->post('event_id') : $event_id;
																	 echo form_dropdown('event_id', $event_array,  $selected,'id="event_id" class="form-control select2" required ');
																	?>
                                                                    </div>
                                                                </div>
                                                          ...
                                                          <!--/row-->
                                                            ...
                                                            <div class="row">
                                                             <div class="col-md-6">
                                                              ...
                                                              <span class="blue">
                                                                    &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>participants_samle_file.csv">Download Sample File</a>
                                                            </span>
