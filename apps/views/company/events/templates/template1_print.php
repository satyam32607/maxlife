...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Source+Sans+3:wght@300;400;500;700;800;900&display=swap" rel="stylesheet">
...
<body style="font-family: 'Source Sans 3', sans-serif; font-size: 13px; margin:0;">

  <page size="A4">
    <table style="width: 100%; margin:0 auto; border-collapse: collapse;">
      <tr>
        <td style="background:url(<?php echo base_url(); ?>assets/img/templates/1/header.jpg); padding:20px; background-repeat: no-repeat;">
          <h1 style="font-weight:300; color:#fff; margin:0;">
            <?php echo date("F Y", strtotime($eventrow->event_date)); ?>
          </h1>
          <h2 style="color:#fff; font-size: 51px; margin:0;">
      ...
      <tr>
        <td style="height: 31px; color:#f23280; font-size: 18px; padding: 0 15px;">
          Block your date for a webinar session as per below mentioned details.
        </td>
      </tr>

      <tr>
        <td>
          <table style="width:80%; border-collapse: collapse;  margin:14px auto;">
            <tr>
              <td colspan="2" style="background: #f23280; font-weight: bold; color:#fff; font-size: 22px; font-weight: 600; padding:2px 5px; text-align: right;">
                Date: <?php echo date("d-m-Y", strtotime($eventrow->event_date)); ?>
              </td>
            </tr>
            <tr>
              <td style="width: 50%; background: #533386; padding:5px 15px; font-size: 20px; border-right:solid 1px #f23280; color:#fff;">
                Time</td>
              <td style="width: 50%; background: #533386; padding:5px 15px; font-size: 20px; border-right:solid 1px #f23280; color:#fff;">
                Agenda</td>
            </tr>
            ...
            ?>
                <tr>
                  <td style="width: 50%;  padding:5px 15px; font-size: 15px; border:solid 1px #000; color:#000;">
      ...
      <tr>
        <td style="padding:0 15px;">
          Please be informed that the session will be attended by the senior leadership hence you need to follow the
          below instruction.
          <br>
          <br>
      ...
      <tr>
        <td style="background-image: url(<?php echo base_url(); ?>assets/img/templates/1/footer.jpg); background-repeat: no-repeat; padding:0 15px">
          <div style="margin:10px 0 0 0; font-size: 28px; color:#f23280; font-weight: 600;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div>
          <div style="margin:0 0 0; font-size: 28px; color:#000; font-weight: 600;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div>
          <div style="padding: 50px 20px 0 20px; margin-top:50px;">
            <h4 style="margin:0; font-size: 28px; color:#f23280; font-weight: 600;">
              For any clarification reachout @
            </h4>
            <h5 style="margin:0; font-size: 28px; color:#fff; font-weight: 600;">
              events@dreamweaversindia.com
            </h5>
  ...
  <script>
    ...
    $(function() {
      ...
      jchart3 = $("#element3").jChart({
        data: [{
            value: <?php echo count($participantsresults); ?>,
            color: {
              normal: '#4f81bd',
              active: '#4f81bd',
            },
      ...
      jchart4 = $("#element4").jChart({
        data: [{
            value: <?php echo $total_attended_full_session; ?>,
            color: {
              normal: '#9bbb59',
              active: '#9bbb59',
            },
