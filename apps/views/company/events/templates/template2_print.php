...
<body style="font-family: 'Roboto', sans-serif; font-size: 13px; margin:0;">
    <page size="A4">
        <table style="width: 100%; margin:0 auto; border-collapse: collapse;">
            <tr>
                <td style="background:url(<?php echo base_url(); ?>assets/img/templates/2/header.jpg); padding:35px 20px 0; background-repeat: no-repeat; background-size: 100%;">
                    <h4 style="font-weight:600; color:#000; margin:0; font-size: 15px; margin-left:45px;">
                        <?php echo date("F Y", strtotime($eventrow->event_date)); ?>
                    </h4>
                    <h4 style="font-weight:600; color:#000; margin:0; font-size: 31px; margin-left:45px;">
                        <?php echo $eventrow->event_name ?>
                    </h4>
                    <!-- <h2 style="color:#ee2526; font-size: 35px; margin:0; margin-left:45px;">
                        <?php echo $eventrow->event_name; ?>
                        <br>
                        <?php echo $eventrow->event_title; ?>
                    </h2> -->
                    <div style="width: 95%; margin:50px 0 auto; font-size: 14px;">
            ...
            <tr>
                <td>
                    <table style="width:90%; border-collapse: collapse;  margin:14px auto 65px; font-family: 'Montserrat', sans-serif;">
                        <tr>
                            <td colspan="2" style="font-family: 'Montserrat', sans-serif; font-weight: 700; color:#ff0000; font-size: 30px; font-weight: 600; padding:2px 5px; text-align: right;">
                                Date:<?php echo date("d-m-Y", strtotime($eventrow->event_date)); ?>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 50%; background: #ff0000; padding:5px 15px; font-size: 20px; font-family: 'Montserrat', sans-serif; border-right:solid 1px #f23280; color:#fff;">
                                Time</td>
                            <td style="width: 50%; background: #ff0000; padding:5px 15px; font-size: 20px; font-family: 'Montserrat', sans-serif; border-right:solid 1px #f23280; color:#fff;">
                                Agenda</td>
                        </tr>
                        ...
                        ?>
                                <tr>
                                    <td style="width: 50%;  padding:5px 15px; font-size: 15px; border:solid 1px #000; border-bottom:solid 1px #ff0000; color:#000;">
            ...
            <tr>
                <td style="padding:0 15px;">
                    <p style="font-weight:600; margin:0;">Please be informed that the session will be attended by the senior leadership hence you need to follow the
                        below instruction.</p>
                    <br>
                    <br>
            ...
            <tr>
                <td style="background-image: url(<?php echo base_url(); ?>assets/img/templates/2/footer.jpg); background-repeat: no-repeat; padding:0 15px; height: 200px; background-size: 100%;">

                    <div>
                        <p style="margin:0; font-size: 15px;"> For any Clarification reach out @ </p>
                        <p style="color:#ff0000; margin:0; font-size: 18px;">events@dreamweaversindia.com</p>
                    </div>
