                  ...
                  <div class="col-md-12">
                    <?php $this->load->view("includes/notifications.php");?>
                      ...
                      <?php  $attributes = array('id' => 'form1','name' => 'form1','class' => 'form-horizontal','role' => 'form','autocomplete' => 'off');
                         echo form_open(base_url().'admin/reports/consent_candidates_date_wise', $attributes);
                       ?>
                    <div class="portlet box blue-hoki">  
                        ...
                        <div class="portlet-body portlet-expand">
                           ...
                           <div class="col-md-2">
                                    <a href="<?php echo base_url();?>admin/reports/consent_candidates_export_to_excel/<?php echo $start_date; ?>/<?php echo $end_date; ?>/<?php echo $search_by; ?>/<?php echo $search_value; ?>" title="Export To Excel" class="btn btn-sm btn-success"> 
                                       <i class="fa fa-file-excel-o fa-2x"></i>&nbsp;&nbsp;Export HDFCLife Format 
                                    </a>
                            </div>
                            
                             <div class="col-md-2 pull right">
                                    <a href="<?php echo base_url();?>admin/reports/consent_candidates_posp_export_to_excel/<?php echo $start_date; ?>/<?php echo $end_date; ?>/<?php echo $search_by; ?>/<?php echo $search_value; ?>" title="Export To Excel" class="btn btn-sm btn-success"> 
                                       <i class="fa fa-file-excel-o fa-2x"></i>&nbsp;&nbsp;Export POPS Format
                                    </a>
                            </div>
