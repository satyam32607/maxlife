                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-blue-madison bold uppercase">Candidates Report </span>
                                                       ...
                                                       <div class="col-md-12">
                                                        ...
                                                        <div class="table-scrollable table-scrollable-borderless">
                                                             <table class="table table-hover table-light">
                                                               ...
                                                               <?php 
															  $total_cand=0; 
															  if(is_array($consolidated_results))
															  {
																 foreach($consolidated_results as $logrow) {
																 $total_cand = $total_cand+$logrow->total;
																 ?>		 
                                                                <tr>
                                                                    <td> <?php echo date("M d, Y",strtotime($logrow->dt)); ?></td>
                                                                    <td><a href="<?php echo base_url();?>admin/apidashboard/posp_log_date_wise/<?php echo $logrow->sponser_id; ?>/<?php echo $logrow->dt; ?>/<?php echo $logrow->dt; ?>"><span class="bold theme-font">[<?php echo $logrow->total; ?>]</span></a> </td>
                                                                </tr>
                                                                <?php
																	}
																   }
