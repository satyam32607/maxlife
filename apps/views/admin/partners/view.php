                            ...
                            if($row->country_id!='0')
                              ...
                              $postuserrow = get_table_info('users','user_id',$row->created_by);
								?>    
                                    ...
                                    <td><a href="<?php echo base_url();?>admin/invoices/view/<?php echo $row->user_id; ?>" title="View Invoices"> <span class="label label-sm label-success">view  [<?php echo $row->total_invoices; ?>] </span></a></td>
