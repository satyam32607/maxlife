                  ...
                  <?php $this->load->view("includes/notifications.php");?>
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Pan No. <span class="required"> * </span></label>
								     <?php $data = array(
                                      'name'        => 'pan_no',
                                      'id'          => 'pan_no',	
                                      'value'       => set_value('pan_no') ? $this->input->post("pan_no") : $edit_data->pan_no,								
                                      'maxlength'   => '10',
                                      'class'   => 'form-control',
                                      'required'   => 'required',
                                      );
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">GST No. <span class="required"> * </span> </label>
                                <?php $data = array(
                                'name'        => 'gst_no',
                                'id'          => 'gst_no',									
                                'value'       => set_value('gst_no') ? $this->input->post("gst_no") : $edit_data->gst_no,		
                                'maxlength'   => '20',
                                'class'   => 'form-control',
								'required'   => 'required',
                                );
                     ...
                     <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Bank Name </label>
								     <?php $data = array(
                                      'name'        => 'bank_name',
                                      'id'          => 'bank_name',	
                                      'value'       => set_value('bank_name') ? $this->input->post("bank_name") : $edit_data->bank_name,									
                                      'maxlength'   => '255',
                                      'class'   => 'form-control',
                                      );
                                   echo form_input($data);
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Bank Beneficiary Name </label>
                                <?php $data = array(
                                'name'        => 'bank_beneficiary_name',
                                'id'          => 'bank_beneficiary_name',									
                                'value'       => set_value('bank_beneficiary_name') ? $this->input->post("bank_beneficiary_name") : $edit_data->bank_beneficiary_name,		
                                'maxlength'   => '255',
                                'class'   => 'form-control',
                                );
                              echo form_input($data);
                              echo form_error('bank_beneficiary_name');
                              ?>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group">
                                <label class="control-label">Bank Account No. </label>
								    <?php $data = array(
										...
										'id'          => 'bank_account_no',									
										'value'       => set_value('bank_account_no') ? $this->input->post("bank_account_no") : $edit_data->bank_account_no,	
										'maxlength'   => '60',
										'class'   => 'form-control',
										);
									  echo form_input($data);
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                'name'        => 'bank_ifsc_code',
                                'id'          => 'bank_ifsc_code',									
                                'value'       => set_value('bank_ifsc_code') ? $this->input->post("bank_ifsc_code") : $edit_data->bank_ifsc_code,		
                                'maxlength'   => '20',
                                'class'   => 'form-control',
                                );
                              echo form_input($data);
                              echo form_error('bank_ifsc_code');
                              ?>
                              </div>
                            </div>
                          </div>
