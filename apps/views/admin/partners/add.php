                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'comp_form','name' => 'comp_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'admin/partners/add', $attributes);
                         ?>
                        <div class="form-body">
                          ...
                          <?php endif; ?>
                          <div class="row">
                            <div class="col-md-12"> <small class="pull-right">Note : Default Password : (Maxlife@123)</small></div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                ?>
                                <small>Note : Primary Email is partner username.</small>
                              </div>
                            </div>
                          </div>
                          <!--/row-->
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <?php $data = array(
                                  'name'        => 'userpass',
                                  'id'          => 'userpass',
                                  'value'       => set_value('userpass') ? $this->input->post("userpass") : "Maxlife@123",
                                  'maxlength'   => '32',
                                  'class'   => 'form-control',
                                  'type'   => 'password',
                                  'minlength'   => '4',
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                'name'        => 'compass',
                                'id'          => 'compass',
                                'value'       => set_value('compass') ? $this->input->post("compass") : "Maxlife@123",
                                'maxlength'   => '32',
                                'class'   => 'form-control',
                                'type'   => 'password',
                                'required'   => 'required',
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                'value'       => set_value('bank_beneficiary_name'),			
                                'maxlength'   => '255',
                                'class'   => 'form-control',
                                );
                              echo form_input($data);
