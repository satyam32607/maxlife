                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 col-sm-9 col-xs-9">
                                                          <?php  $attributes = array('id' => 'upload_customers_form','name' => 'upload_customers_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                                                                 echo form_open_multipart(base_url().'admin/candidates/upload_bulk_candidates', $attributes);
                                                          ?>
                                                         <div class="form-body">
                                                              ...
                                                              <div class="row">
                                                               ...
                                                               <div class="col-md-6">
                                                                   ...
                                                                   <?php
																	 ...
																	 echo form_dropdown('bank_id', $bank_array,  $selected,'id="bank_id" class="form-control select2" required ');
																	?>
                                                                    </div>
                                                                </div>
