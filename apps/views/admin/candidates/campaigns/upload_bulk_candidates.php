                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 col-sm-9 col-xs-9">
                                                          <?php  $attributes = array('id' => 'upload_customers_form','name' => 'upload_customers_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                                                                 echo form_open_multipart(base_url().'admin/campaigns/upload_bulk_candidates', $attributes);
                                                          ?>
                                                         <div class="form-body">
                                                        ...
                                                        <?php endif; ?>
                                                               ...
                                                               <div class="col-md-6">
                                                                   ...
                                                                   <?php
																	 $fields = array('is_active'=>'1');
																 	 $campaigns_array = gettabledropdown('campaigns',$fields,'campaign_id','campaign_name','campaign_name','ASC');
                                                            ...
                                                            <div class="row">
                                                             <div class="col-md-6">
                                                              ...
                                                              <span class="blue">
                                                                    &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>admin/branches/sample_file_download">Download Sample File</a>
                                                            </span>
