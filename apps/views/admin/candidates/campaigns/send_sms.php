                  ...
                  <?php $this->load->view("includes/notifications.php");?>
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'sendsms_form','name' => 'sendsms_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'admin/campaigns/send_sms', $attributes);
                        ...
                        <div class="form-body">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                               ...
                               <?php 
							  $sms_template_array = $this->campaigns_model->get_sms_email_templates('s');
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">SMS Text<span class="required"> * </span></label>
                                  <?php
									  $data = array(
									  'name'        => 'sms_body',
									  'id'          => 'sms_body',	
									  'value'       => set_value('sms_body') ? $this->input->post("sms_body") : '',
									  'rows'   => '5',									
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label>Candidates List</label>
                                 <div style="height:180px; margin-left:10px;overflow-y:scroll">
                                       <div class="md-checkbox-list">
                                       <?php
									    $candidates_array=$this->campaigns_model->get_alert_candidates_list($campaign_id);
									    if(is_array($candidates_array))
                                        {
                                    	 foreach($candidates_array as $candrow){
									   ?>
                                        <div class="md-checkbox">
                                            <input id="campaign_log_id<?php echo $candrow->campaign_log_id; ?>" name="campaign_log_id[]" value="<?php echo $candrow->campaign_log_id; ?>" class="md-check checkbox_ids" type="checkbox">
                                           
                                            <label for="campaign_log_id<?php echo $candrow->campaign_log_id; ?>">
                                                <span class="inc"></span>
                                                <span class="check"></span>
                                                <span class="box"></span><?php echo $candrow->applicant_full_name; ?> - <?php echo $candrow->mobile_no; ?> </label>
                                        </div>
                                        <?php 
                                          }
                                        }
                                    ...
                                    <?php echo form_error('campaign_log_id[]'); ?>
                              </div>
                            </div>
                          </div>
...
$('#template_id').change(function(){
		...
		//alert(template_array[1]);
		if(template_array[1]!='')
		{
			$('#sms_body').val("");
			$('#sms_body').val(template_array[1]);
		}
		});
