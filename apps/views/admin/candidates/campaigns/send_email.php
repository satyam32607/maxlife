          ...
          <div class="page-content">
            <div class="container"> 
              ...
              <ul class="page-breadcrumb breadcrumb">
                ...
                <li> <a href="<?php echo base_url(); ?>schools/campaigns/view"><?php echo $main_heading; ?></a> <i class="fa fa-circle"></i> </li>
                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'sendemail_form','name' => 'sendemail_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'admin/campaigns/send_email', $attributes);
                        ...
                        <div class="form-body">
                          ...
                          <div class="col-md-6">
                            ...
                            <?php 
							  $sms_template_array = $this->campaigns_model->get_sms_email_templates('e');
									   ...
									   ?>
                                        <div class="md-checkbox">
                                            ...
                                            <label for="campaign_log_id<?php echo $candrow->campaign_log_id; ?>">
                                                ...
                                                <span class="box"></span><?php echo $candrow->applicant_full_name; ?> - <?php echo strtolower($candrow->email_id); ?> </label>
                                        </div>
                                        <?php 
                                          }
                                        }
