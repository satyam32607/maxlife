                  ...
                  <div class="col-md-12">
                         ...
                         <?php  $attributes = array('id' => 'form1','name' => 'form1','class' => 'form-horizontal','role' => 'form','autocomplete' => 'off');
                          ...
                          <div class="portlet box blue-hoki">  
                            ...
                            <div class="portlet-body portlet-expand">
                                ...
                                <div class="col-md-4">
                                 <label>Search by Contact Number, Candidate name, Bank account no.</label>
                                <?php
                    ...
                    <div class="portlet-body">
                        <div class="table-responsive"  style="font-size:11px !important;">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                   ...
                                   <td>
                                       ...
                                       <a class="label label-sm label-success get_data_id" data-id="<?php echo $row->candidate_id; ?>" data-toggle="modal" href="#responsive"> get statement </a>
                          ...
                          <a class="label label-sm label-success btn show-loader" data-toggle="modal" data-url="<?php echo base_url();?>admin/transactions/statement/<?php echo $row->candidate_id; ?>">print</a> 
                                       
                         <center><a href="<?php echo base_url();?>admin/transactions/statement/<?php echo $row->candidate_id; ?>" style="text-align:center;"><i class="fa fa-print"></i></a></center>
                                      </td>
