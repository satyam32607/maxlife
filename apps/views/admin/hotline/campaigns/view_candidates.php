                    ...
                    <?php $this->load->view("includes/notifications.php");?>
                      <!-- BEGIN FILTER TABLE-->
                         <?php  $attributes = array('id' => 'form1','name' => 'form1','class' => 'form-horizontal','role' => 'form','autocomplete' => 'off');
							 echo form_open(base_url().'admin/hotline/campaigns/candidates', $attributes);
				          ?>
                        ...
                        <div class="table-responsive"  style="font-size:11px !important;">
                              <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                   ...
                                   <!-- <td><?php if($row->is_active=='1') {?><a class="label label-sm label-success" onclick="return confirm('Do you want to de-activate this User account ?');" href="<?php echo base_url();?>admin/hotline/campaigns/status/<?php echo $row->cand_call_detail_id; ?>/0"><?php echo  'Active'; ?></a><?php }
                                     else { ?><a class="label label-sm label-danger" onclick="return confirm('Do you want to activate this User account ?');" href="<?php echo base_url();?>admin/hotline/campaigns/status/<?php echo $row->cand_call_detail_id; ?>/1"><?php echo 'De-Active';?> </a> <?php } ?></td>-->
                                    </tr>
                                     <?php 
									  } 
									} ?>
