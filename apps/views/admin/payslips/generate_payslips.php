                            ...
                            <div class="page-content">
                                ...
                                <?php $this->load->view("includes/notifications.php");?>
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                          ...
                                          <li>
                                            <a href="<?php echo base_url(); ?>admin/payslips/view"><?php echo $main_heading; ?></a>
                                            <i class="fa fa-circle"></i>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 col-sm-9 col-xs-9">
                                                          <?php  $attributes = array('id' => 'upload_customers_form','name' => 'upload_customers_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                                                                 echo form_open_multipart(base_url().'admin/payslips/generate', $attributes);
                                                          ?>
                                                         <div class="form-body">
                                                          ...
                                                          <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                      <label class="control-label">Select Company <span class="required"> * </span></label>
                                                                   <?php
																	 $fields = array('is_active'=>'1');
																 	 $company_array = gettabledropdown('companies',$fields,'company_id','company_name','company_name','ASC');
																	 $selected = ($this->input->post('company_id')) ? $this->input->post('company_id') : $bank_id;
																	 echo form_dropdown('company_id', $company_array,  $selected,'id="company_id" class="form-control select2" required ');
																	?>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                  <div class="form-group">
                                                                    <label class="control-label">From Period<span class="required"> * </span></label>
                                                                    <div class="input-group date" data-date-format="yyyy-mm-dd">
                                                                         <?php $data = array(
                                                                              'name'        => 'from_period',
                                                                              'id'          => 'from_period',
                                                                              'value'       => set_value('from_period'),
                                                                              'maxlength'   => '15',
                                                                              'redonly'  => true,
                                                                              'class'   => 'form-control',
                                                                ...
                                                                <div class="col-md-6">
                                                                  <div class="form-group">
                                                                    <label class="control-label">To Period<span class="required"> * </span></label>
                                                                    <div class="input-group date" data-date-format="yyyy-mm-dd">
                                                                         <?php $data = array(
                                                                              'name'        => 'to_period',
                                                                              'id'          => 'to_period',
                                                                              'value'       => set_value('to_period'),
                                                                              'maxlength'   => '15',
                                                                              'redonly'  => true,
                                                                              'class'   => 'form-control',
                                                                              'placeholder'   => 'YYYY-MM-DD',
                                                          ...
                                                          <!--/row-->
                                                            ...
                                                            <div class="row">
                                                             <div class="col-md-6">
                                                              ...
                                                              <span class="blue">
                                                                    &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>admin/candidates/payslip_sample_file_download">Download Sample File</a>
                                                            </span>
...
<script>
		...
		changeMonth: true,startDate: '-2y',endDate: '0',
        format: 'yyyy-mm-dd',
		 autoclose: true,
  		 }).on('changeDate', function(e) {
		  var date2 = $('#from_period').datepicker('getDate', '+30d'); 
		  date2.setDate(date2.getDate()+30); 
		  //alert(date2);
		  $('#to_period').datepicker('setDate', date2);
 		});
