                                                             ...
                                                             <table class="table table-hover table-light">
															  ...
															  if(is_array($consolidated_results))
															  {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url();?>admin/apidashboard/log_date_wise/<?php echo $logrow->sponser_id; ?>/<?php echo $logrow->dt; ?>/<?php echo $logrow->dt; ?>"><span class="bold theme-font">[<?php echo $logrow->total; ?>]</span></a> </td>
                                                                </tr>
                                                                <?php
																	}
																   }
