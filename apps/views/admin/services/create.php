                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'camp_form','name' => 'camp_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'admin/services/add', $attributes);
                         ?>
                        <div class="form-body">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <?php
									...
									$selected = ($this->input->post('company_id')) ? $this->input->post('company_id') : '2';
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <?php
									...
									$selected = ($this->input->post('category_id')) ? $this->input->post('category_id') : set_value('category_id');
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'service_name',
									  'id'          => 'service_name',	
									  'value'       => set_value('service_name') ? $this->input->post("service_name") : set_value('service_name'),			
									  'maxlength'   => '100',
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'service_price',
									  'id'          => 'service_price',	
									  'value'       => set_value('service_price') ? $this->input->post("service_price") : set_value('service_price'),			
									  'maxlength'   => '10',
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'service_code',
									  'id'          => 'service_code',	
									  'value'       => set_value('service_code') ? $this->input->post("service_code") : set_value('service_code'),			
									  'maxlength'   => '60',
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  ...
									  'value'       => set_value('service_short_name') ? $this->input->post("service_short_name") : set_value('service_short_name'),			
									  'maxlength'   => '100',
									  'class'   => 'form-control',
									  );
								   echo form_input($data);
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'hsn_code',
									  'id'          => 'hsn_code',	
									  'value'       => set_value('hsn_code') ? $this->input->post("hsn_code") : set_value('hsn_code'),			
									  'maxlength'   => '20',
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'gst_rate',
									  'id'          => 'gst_rate',	
									  'value'       => set_value('gst_rate') ? $this->input->post("gst_rate") : set_value('gst_rate'),			
									  'maxlength'   => '10',
									  'class'   => 'form-control',
									  );
								   echo form_input($data);
                              ...
                              <div class="form-group">
                                ...
                                <?php
								    $data = array(
									  'name'        => 'tds',
									  'id'          => 'tds',	
									  'value'       => set_value('tds') ? $this->input->post("tds") : set_value('tds'),			
									  'maxlength'   => '10',
									  'class'   => 'form-control',
									  'required'   => 'required',
									  );
                            ...
                            <div class="col-md-6">
                              ...
                              <label>Service Description </label>
                               <?php $data = array(
                                  ...
                                  'value'       => set_value('service_description'),
                                   'rows'   => '4',									
                                  'class'   => 'form-control',
                                  );
