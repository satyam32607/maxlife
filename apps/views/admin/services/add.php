                  ...
                  <?php $this->load->view("includes/notifications.php");?>
                    <div class="portlet box green">
                      <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-bank"></i><?php echo $heading; ?> </div>
                      </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select name="services[]" class="form-control" required>
                                      ...
                                      foreach ($services as $service) {
                                        echo  "<option value='$service->service_id' class='form-control'>$service->service_name - $service->hsn_code </option>";
                                      }
                                      ?>
                                    </select>
                                  </div>
