                        ...
                        <div class="table-responsive">
                              <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url();?>admin/dw/courses/view_pages/<?php echo $language_id; ?>/<?php echo $row->chapter_id; ?>" title="View Candidates"> <span class="label label-sm label-success">View [<?php echo $row->total_pages; ?>] </span> </a>  </td>
                                    </tr>
                                     <?php 
									  } 
									} ?>
