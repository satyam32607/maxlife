...
<html lang="en">
   ...
   <body>
      ...
      <page size="A4">
                  ...
                  <tr>
                     ...
                     <td style="text-align:left; padding-left:35px; width:50%; vertical-align:top;" >
                        ...
                        <table style="border-spacing:0; line-height:17px;margin-top:10px;" cellpadding="5">
                           ...
                           <?php 
                            $ifscrow=get_table_info('bank_ifsc_codes','ifsc_code',$candrow->ifsc_code);
                            ?>
                           <tr style="font-size:15px;">
                              <td><?php echo nl2br($ifscrow->branch_address); ?></td>
                           </tr>
                     ...
                     <td style="vertical-align:top;">
                        ...
                        <table style="border-spacing:0; line-height:18px;margin-top:10px; width:100%;" cellpadding="4">
                           ...
                           <tr>
                              <td>Branch </td>
                              <td>: <?php echo $candrow->ifsc_code; ?></td>
                              </tr>
                          <tr>
                     ...
                     <td style="padding:0 25px;">
                        ...
                        <table style="width:100%; border-spacing:0;">
                         <tr>
                              ...
                              <td colspan="5" style="padding:5px; height:20px;"></td>
						  ...
						  {  
                           ...
                           <tr style="font-size:15px;">
                             ...
                             <td>:</td>
                              ...
                              <td align="right"><?php echo price_format($openingbalance); ?> (Cr)</td>
        ...
        <table style="width:98%; margin:150px auto 0 50px; border-spacing:0;  font-size:11px;">
...
margin-bottom: 20px;">
      ...
      <div>
         ...
         Date: <span><?php
             $days =  rand(25,45);
             $random_trans_date=date("Y-m-d",strtotime("+".$days." days",strtotime($last_trans_date))); 
             
             echo date("D M d",strtotime($random_trans_date));
             echo date(" h:i:s");
             echo '  IST ' .date("Y",strtotime($random_trans_date));?>
...
<table style="width:98%; margin:80px auto 0 50px; border-spacing:0;  font-size:12px;">
