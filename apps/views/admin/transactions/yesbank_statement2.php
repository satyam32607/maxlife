   ...
   <body>
      <page size="A4">
         ...
         <div style="width:100%; padding:20px 50px 20px 40px">
            <!-- header -->
             <table style="width:800px; border-spacing:0; margin:20px 20px 10px;">
                     <tr>
                  ...
                  <div style="height:950px;">
                     <!-- Account Proof -->
                     <table style="width:800px; border-spacing:0; margin:0 20px; font-size:12px;">
                        <tr>
                      ...
                      <!-- notification -->
                     <table style="width:800px; margin:10px auto; font-size:09px; color: #000;">
                        <tr>
                           <td>
                     ...
                     <!-- Statement Summary -->
                     <table style="width:800px ; border:solid 2px #045191; margin: 0 auto; border-spacing:0;">
                        <thead>
                           <tr>
                        ...
                        <?php 
						  ...
						  {  
                           ...
                           <tr>
                              ...
                              <td style="padding:8px 10px; font-size:12px; text-align:center;">
                                 <i class="fa-solid fa-indian-rupee-sign"></i> <?php echo price_format(($opening_balance+$candrow->opening_balance)); ?>
                              </td>
                              <td style="padding:8px 10px; font-size:12px; text-align:center;">
                     ...
                     <!-- Statement summary -->
                     <table style="width:800px; margin:0 auto; font-size:10px; padding:10px 0">
                        <tr>
                    ...
                    <table style="width:800px; margin: 10px auto; border-spacing:0;">
                        <thead>
                           <tr>
                              <th nowrap style="background:#045191; color:#fff; padding:8px 10px; font-size:12px; width:90px;">
                                 Txn Date
                              </th>
                              <th style="background:#045191; color:#fff; padding:8px 10px; font-size:12px; width:100px;">
                                 Narration
                              </th>
        ...
        <table style="width:930px; border-spacing:0;  font-size:15px;">
            ...
            <tr>
               <td style="color:#fff; width:50%; background:#045191; padding:0px 10px 10px 20px;">
                 ...
                 <br>
<span style="font-size:13px; font-weight:300; color:#78B8C8;">Finnew Solutions Private Limited<br>
...
E mail: care@goniyo com Phone: 1800 258 3009</span>
               ...
               <td style="color:#fff; vertical-align:top; width:50%; background:#045191; padding:0px 20px 10px 10px; text-align:right; ">
                  ...
                  <br>
<span style="font-size:13px; font-weight:300; color:#78B8C8;">Yes Bank Tower, IFC 2, 15th Floor,<br>
            ...
            <!-- header -->
             <table style="width:800px; border-spacing:0; margin:20px 20px 10px;">
                  ...
                  <div style="height:950px;">
                    ...
                    <table style="width:800px; margin: 10px auto; border-spacing:0;">
                        <thead>
                           <tr>
                              ...
                              <th style="background:#045191; color:#fff; padding:8px 10px; font-size:11px; width:100px;">
                                 Narration
                              </th>
                   ...
                   <!--  Statement -->
                         <table style="width:800px; margin:0 auto; font-size:12px;">
...
4. In the event of any dispute or grievance in relation to the Niyo Prepaid Card, the customer may contact the YES Bank 24 hours Customer Care number at 1800 103 5485 /1800 3000 1113 or <br> Email:Niyopay.support@yesbank.in.
