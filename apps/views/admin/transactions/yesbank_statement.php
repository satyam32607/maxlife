   ...
   <body>
      <page size="A4">
         ...
         <div style="width:100%; padding:20px 50px 20px 40px">
            <!-- header -->
             <table style="width:820px; border-spacing:0; margin:20px 20px 10px;">
                     <tr>
                  ...
                  <div style="height:950px;">
                     <!-- Account Proof -->
                     <table style="width:820px; border-spacing:0; margin:0 20px; font-size:12px;">
                        <tr>
                      ...
                      <!-- notification -->
                     <table style="width:820px; margin:10px auto; font-size:9px; color: #000;">
                        <tr>
                           <td style="width:820px; margin:10px auto; font-size:8px;color: #000; padding-left: 40px; font-weight:700;">
                      ...
                      <!-- Account Statement -->
                     <table style="width:820px; margin:0 auto; font-size:10px;">
                        <tr>
                           <td style="text-align:center; border-top:solid 3px #045191; padding-top:3px; font-weight:bold; color:#045191; font-size:18px;">
                             <span style="padding-left:60px;"> Account Statement</span>
                           </td>
                        </tr>
                        <tr>
                           <td style=" font-size:09.5px;">
                              <p style="background:#c5c4c4; padding:5px;">
                                 NEVER SHARE your Card number, CVV, PIN, OTP, Password or URN with anyone, even if the caller claims to be a bank employee. 
                                  Sharing these details can lead to unauthorised access <br> to your account.
                              </p>
                           </td>
                        </tr>
                     ...
                     <!-- Statement Summary -->
                     <table style="width:820px ; border:solid 2px #045191; margin: 0 auto; border-spacing:0;">
                        <thead>
                           <tr>
						  ...
						  {  
                           ...
                           <tr>
                              ...
                              <td style="padding:8px 10px; font-size:12px; font-size:12px; text-align:center;">
                                 <i class="fa-solid fa-indian-rupee-sign"></i> <?php echo price_format($totalbalance); ?>
                              </td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <!-- Statement summary -->
                     <table style="width:820px; margin:0 auto; font-size:10px; padding:7px 0">
                        <tr>
                    ...
                    <table style="width:820px; margin: 5px auto; border-spacing:0;">
                        <thead>
                           <tr>
                       ...
                       <?php 
                       $total_results = count($results); 
                       if($total_results<=1 && $total_results<3)
                       $footer_height='60';  
                       elseif($total_results<=4 && $total_results<=5)
                        $footer_height='20';
                       else
                       $footer_height='10';      
                       ...
                       ?>
                               <!--  Statement -->
                                 <table style="width:820px; margin:0 auto; font-size:12px;">

                                <tr>
                                   <td style="font-size:12px;" height="<?php echo $footer_height; ?>" align="center">
                     ...
                     <table style="width:820px; margin:0 auto 0 20px; font-size:12px;">
...
4. In the event of any dispute or grievance in relation to the Niyo Prepaid Card, the customer may contact the YES Bank 24 hours Customer Care number at 1800 103 5485 /1800 3000 1113 or  Email: <br>Niyopay.support@yesbank.in.
        ...
        <table style="width:930px; border-spacing:0;  font-size:15px;">
            <tr>
               ...
               <?php
                  $total_results = count($results); 
                  $get_total_pages =round($total_results/11)+1;  
            ...
            <tr>
               <td style="color:#fff; width:50%; background:#045191; padding:0px 10px 10px 20px;">
                 ...
                 <br>
<span style="font-size:14px; font-weight:300; color:#95B6BA;">Finnew Solutions Private Limited<br>
...
E mail: care@goniyo com Phone: 1800 258 3009</span>
               ...
               <td style="color:#fff; vertical-align:top; width:50%; background:#045191; padding:0px 20px 10px 10px; text-align:right; ">
                  ...
                  <br>
<span style="font-size:14px; font-weight:300; color:#95B6BA;">Yes Bank Tower, IFC 2, 15th Floor,<br>
...
Mumbai 400 013</span>
  ...
  <?php
        ...
        //$get_pending_total_pages =round($pendingresults/11);
            ...
            <!-- header -->
             <table style="width:820px; border-spacing:0; margin:20px 20px 10px;">
                  ...
                  <div style="height:950px;">
                     ...
                     <!-- Statement Transactions -->
                    <table style="width:820px; margin: 10px 0 0 20px; border-spacing:0;">
                        <thead>
                           <tr>
                              <th nowrap style="background:#045191; color:#fff; padding:8px 10px; font-size:14px; width:90px;">
                                 Txn Date
...
4. In the event of any dispute or grievance in relation to the Niyo Prepaid Card, the customer may contact the YES Bank 24 hours Customer Care number at 1800 103 5485 /1800 3000 1113 or  Email: <br>Niyopay.support@yesbank.in.
       ...
       <table style="width:930px; border-spacing:0;  font-size:15px;">
            <tr>
               ...
               <?php
                  $total_results = count($results); 
                  $get_total_pages =round($total_results/11);  
                   
                  $pendingresults = count($pendingresults);
                  if($pendingresults>0){ ?> 
                   2 of 2
                  <?php } else { ?>
                   
                  2 of <?php echo $get_total_pages; ?> 
