                              ...
                              <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                    ...
                                    <td><?php echo $row->mobile_no1; ?></td>
              					   <td><a href="<?php echo base_url();?>admin/partners/view/<?php echo $row->user_id; ?>" title="View Partners"> <span class="label label-sm label-success"> [<?php echo $row->total_partners; ?>] </span></a></td>
