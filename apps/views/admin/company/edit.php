                            ...
                            <?php $this->load->view("includes/notifications.php");?>
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>admin/companies/view"><?php echo $main_heading; ?></a>
                                            <i class="fa fa-circle"></i>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 col-sm-9 col-xs-9">
                                                          <?php  $attributes = array('id' => 'comp_form','name' => 'role_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
															     echo form_open_multipart(base_url().'admin/companies/edit/'.$edit_data->user_id.'', $attributes);
                                                        ...
                                                        <?php endif; ?>
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label">Alternate Email</label>
                                                                          <?php $data = array(
																			  ...
																			  'id'          => 'alternate_email',	
																			  'value'       => $edit_data->alternate_email,							
																			  'maxlength'   => '100',
																			  'class'   => 'form-control',
																			  'email'   => true,
																			  );
                                                              ...
                                                              <div class="col-md-6">
                                                               ...
                                                               <?php
																...
																$selected = ($this->input->post('time_zone')) ? $this->input->post('time_zone') : $edit_data->time_zone;
                                                            ...
                                                            <!--/row-->
                                                                ...
                                                                <div class="col-md-6">
                                                                  <div class="form-group">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $selected = ($this->input->post('workflow_limit')) ? $this->input->post('workflow_limit') : $workflow_limit;
                                                             ...
                                                             <!--/row-->
                                                              ...
                                                              <?php 
																 $this->load->view("modules/edit_call_setting");
															   ?>
                                                              ...
                                                              <div class="form-group">
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" id="dvPreview">
																		   ...
																		   {
																		        $photo    ='<img id="preview" src="'.base_url().'assets/static/'.$edit_data->user_id.'/user_photos/resized/'.$edit_data->user_photo.'"> ';
																		   }
																		   else
																		   {
                                                          ...
                                                          <div class="row">
                                                            <div class="col-md-12">
																	...
																	<?php $data = array(
                                                                      ...
                                                                      'id'          => 'company_profile',	
                                                                      'value'       => $edit_data->company_profile,
																	  'rows'       => '6',
                                                                      'class'   => 'form-control',
                                                                      );
                                                                     echo form_textarea($data);
                                                         ...
                                                         <div class="row">
                                                                    ...
                                                                    <div  style="height:350px;  margin-left:10px;overflow-y:scroll">
                                                                        <div class="md-checkbox-list">
                                                                            <div class="md-checkbox">
                                                                               ...
                                                                               <?php
                                                                                $default_opt=array();
																				if($edit_data->user_rights!='null' && $edit_data->user_rights!='')
                                                                                 $default_opt=json_decode($edit_data->user_rights,true);
																				
                                                                                echo $this->master_model->navigate_rights('C',$default_opt);
                                                                                ?>
                                                                        </div>
                                                                    </div>
                                                                    <?php echo form_error('role_rights[]'); ?>
                                                                  </div>
                                                                </div>        
                                                             </div>
                                                          </div>
                                                          ...
                                                          <div class="row">
                                                            <div class="col-md-12">
                                                            <div class="form-group">
                                                                    <label class="col-md-3 control-label">Users Modules  <span class="required"> * </span></label>
                                                                    <div class="col-md-9">
                                                                    <div  style="height:350px;  margin-left:10px;overflow-y:scroll">
                                                                        <div class="md-checkbox-list">
                                                                            <div class="md-checkbox">
                                                                               ...
                                                                               <?php
                                                                                $default_opt=array();
																				if($edit_data->user_modules!='null' && $edit_data->user_modules!='')
                                                                                 $default_opt=json_decode($edit_data->user_modules,true);
																				
                                                                                echo $this->master_model->navigate_rights('U',$default_opt);
                                                                                ?>
                                                                        </div>
                                                                    </div>
                                                                    <?php echo form_error('user_modules[]'); ?>
                                                                  </div>
                                                                </div>        
                                                             </div>
                                                          </div>
