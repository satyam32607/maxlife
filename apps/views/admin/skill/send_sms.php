          ...
          <div class="page-content">
            <div class="container"> 
              ...
              <ul class="page-breadcrumb breadcrumb">
                ...
                <li> <a href="<?php echo base_url(); ?>admin/skill/view"><?php echo $main_heading; ?></a> <i class="fa fa-circle"></i> </li>
                    ...
                    <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                        ...
                        <?php  $attributes = array('id' => 'sendsms_form','name' => 'sendsms_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                   	        echo form_open_multipart(base_url().'admin/skill/send_sms', $attributes);
                        ...
                        <div class="form-body">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                               ...
                               <?php 
							  $sms_template_array = $this->skill_model->get_sms_email_templates('s');
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label>Candidates List</label>
                                 <div style="height:480px; margin-left:10px;overflow-y:scroll; font-size:12px;">
                                       <div class="md-checkbox-list">
                                       <?php
									    $candidates_array=$this->skill_model->get_alert_candidates_list('sms');
									   ...
									   ?>
                                        <div class="md-checkbox">
                                            ...
                                            <label for="candidate_id<?php echo $candrow->candidate_id; ?>">
                                                ...
                                                <span class="box"></span><?php echo $candrow->candidate_name; ?> - <?php echo $candrow->candidate_mobile_no; ?> </label>
                                        </div>
                                        <?php 
                                          }
                                        }
