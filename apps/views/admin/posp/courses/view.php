                        ...
                        <div class="table-responsive">
                              <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url();?>admin/posp/courses/view_chapters/<?php echo $row->course_id; ?>" title="View Candidates"> <span class="label label-sm label-success">View [<?php echo $row->total_chapters; ?>] </span> </a>  </td>
