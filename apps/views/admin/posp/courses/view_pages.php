                        ...
                        <div align="right" class='mypagination'><?php echo $links; ?></div>
                              <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                   ...
                                   <td>
                                     <?php  $attributes = array('id' => 'form1','name' => 'form1','class' => 'form-horizontal','role' => 'form','autocomplete' => 'off');
									 echo form_open_multipart(base_url().'admin/posp/courses/upload_audio_file', $attributes);
                                  ...
                                  <div class="row">
                                    ...
                                    <audio preload='none' class='ms-lg-auto' controls controlsList='nodownload'>
                                     <source src='<?php echo base_url(); ?>assets/static/pospaudios/<?php echo $row->audio_file_name; ?>' type='audio/mpeg'>
