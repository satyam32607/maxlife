          ...
          <div class="page-content">
            <div class="container"> 
              ...
              <ul class="page-breadcrumb breadcrumb">
                ...
                <li> <a href="<?php echo base_url(); ?>partners/invoices/view"><?php echo $main_heading; ?></a> <i class="fa fa-circle"></i> </li>
                  ...
                  <?php $this->load->view("includes/notifications.php");?>
                    <div class="portlet box green">
                      ...
                      <?php  $attributes = array('id' => 'comp_form','name' => 'role_form','class' => 'horizontal-form','role' => 'form','autocomplete' => 'off');
                                echo form_open_multipart(base_url().'partners/invoices/edit/'.$edit_data->invoice_id.'', $attributes);
                                echo form_hidden('invoice_id', $edit_data->invoice_id);
                        ?>
                        <div class="form-body">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <?php $data = array(
                                    ...
                                    'id'          => 'invoice_date',	
                                    'type'          => 'date',	
                                    'value'       => set_value('invoice_date') ? $this->input->post("invoice_date") : $edit_data->invoice_date,									
                                    'maxlength'   => '20',
                                    'class'   => 'form-control',
                                    'required'   => 'required',
                                    );
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              'name'        => 'user_remarks',
                              'id'          => 'user_remarks',	
                              'value'       => set_value('user_remarks') ? $this->input->post("user_remarks") : $edit_data->user_remarks,
                              'rows'       => '6',
                              'class'   => 'form-control',
                              );
