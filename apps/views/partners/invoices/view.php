          ...
          <div class="page-content">
            <div class="container"> 
              ...
              <div class="row">
               ...
               <div class="col-md-4"><a href="<?php echo base_url();?>partners/invoices/add" class="btn btn-circle btn-success pull-right"> <i class="fa fa-plus"></i><span class="hidden-xs"> Create Invoice </span> </a></div>
							   ...
							   <?php 
                                ...
                                ?>    
                                    ...
                                    <td><?php echo date('d M, Y',strtotime($row->invoice_date));?></td>
                                     <td align="center"><a href="<?php echo base_url(); ?>partners/invoices/details/<?php echo $row->invoice_id; ?> "><i class="icon-envelope"></i></a></td>
