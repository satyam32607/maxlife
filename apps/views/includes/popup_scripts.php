...
<!--         <script src="<?php echo base_url();?>assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>-->
        ...
        <script src="<?php echo base_url();?>assets/pages/scripts/ui-extended-modals.js" type="text/javascript"></script>
        <script>
			var currentname= '<?php echo $this->session->userdata('f_name')." ".$this->session->userdata('l_name'); ?>';
			var post_out_img = '<?php echo base_url(); ?>assets/layouts/layout/img/avatar3';
			var post_in_img = '<?php echo base_url(); ?>assets/layouts/layout/img/avatar2';
		</script>
       ...
       <!-- <script src="<?php echo base_url();?>assets/layouts/layout3/scripts/demo.min.js" type="text/javascript"></script>-->
		...
		/*$(window).load(function() {
            $(".top-menu").clone().prependTo(".page-header-menu > .container > .page-header-top");
        });*/
