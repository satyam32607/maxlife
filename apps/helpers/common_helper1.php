  ...
  function send_sms($mobile,$body)
	 {
		...
		// $url='http://www.smsjust.com/sms/user/urlsms.php?username=DREAMINSURANCE&pass=Fd1w@6Z_&senderid=DRMWVR&dest_mobileno='.$numbers.'&message='.$sms_msg.'&response=Y'; 
		   
	 $url='http://www.smsjust.com/sms/user/urlsms.php?username=HDFCLI&pass=hdfclife@1234&senderid=HDFCLF&dest_mobileno='.$numbers.'&message='.$sms_msg.'&response=Y'; 
	 // echo $url;
	  ///echo "<br><br>";
		$curl = curl_init();
...
function common_mail($to_email,$alternate_email,$email_subject=NULL,$email_body=NULL,$attachment1=NULL,$attachment2=NULL){
   ...
   // echo "----from_email---------->".$from_email;
	...
	$mail->setFrom($from_email, 'HDFC Life');
	//Set an alternative reply-to address
	$mail->addReplyTo($from_email, 'HDFC Life');
	//Set who the message is to be sent to
	$mail->addAddress($to_email, 'HDFC Life');
	...
	$mail->AltBody = 'Congratulations! You have been shortlisted to become HDFC Life Agent.';
