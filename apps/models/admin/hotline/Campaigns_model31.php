	 ...
	 function update_call_status($campaign_id)
		{
		  ...
		  if($total_update_records <$camprow->maximum_calls)
			...
			}else
			{
				...
				elseif($campaign_stage>100000 && $campaign_stage<=150000)
				{
				 $new_call_duration=rand(3620,7000);
				// echo "---------->Stage2";
				}
				elseif($campaign_stage>150000 && $campaign_stage<=200000)
				{
				 $new_call_duration=rand(7200,10500);
				// echo "---------->Stage3";
				}
				elseif($campaign_stage>200000 && $campaign_stage<=250000)
				{
				 $new_call_duration=rand(10600,14300);
				// echo "---------->Stage4";
				}
				elseif($campaign_stage>250000 && $campaign_stage<=300000)
				{
				 $new_call_duration=rand(14500,18000);
				// echo "---------->Stage5";
				}
				elseif($campaign_stage>300000 && $campaign_stage<=350000)
				{
				 $new_call_duration=rand(18100,21600);
				// echo "---------->Stage6";
				}
				elseif($campaign_stage>350000 && $campaign_stage<=400000)
				{
				 $new_call_duration=rand(21800,28600);
				// echo "---------->Stage7";
				}
				elseif($campaign_stage>400000 && $campaign_stage<=450000)
				{
				 $new_call_duration=rand(28800,32750);
				// echo "---------->Stage8";
				}
				elseif($campaign_stage>450000 && $campaign_stage<=500000)
				{
				 $new_call_duration=rand(32860,36000);
				// echo "---------->Stage9";
				}
				elseif($campaign_stage>500000 && $campaign_stage<=6000000)
				{
	 ...
	 function process_data($campaign_id)
		{
			...
			//Fetch all Candidates Data
			$this->db->select('campaign_districts.district_id,campaign_districts.data_limit,districts.district_name');
